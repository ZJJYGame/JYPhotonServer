...
namespace AscensionServer
{
    ...
    public class RTGenericValuePair<TValue1, TValue2> : IEquatable<RTGenericValuePair<TValue1, TValue2>>
    {
        TValue1 value1;
        TValue2 value2;
        ...
        public RTGenericValuePair(TValue1 value1, TValue2 value2)
        {
            this.value1 = value1;
            this.value2 = value2;
        }
        public static bool operator ==(RTGenericValuePair<TValue1, TValue2> a, RTGenericValuePair<TValue1, TValue2> b)
        {
            return a.Equals(b);
        }
        public static bool operator !=(RTGenericValuePair<TValue1, TValue2> a, RTGenericValuePair<TValue1, TValue2> b)
        ...
        {
            return obj is RTGenericValuePair<TValue1, TValue2> && Equals((RTGenericValuePair<TValue1, TValue2>)obj);
        }
        ...
        /// Equals方法需要注意，若在对象未覆写Equals时，值类型比较值是否相同，引用类型比较地址是否相同；
        /// </summary>
        public bool Equals(RTGenericValuePair<TValue1, TValue2> other)
        {
            bool result = false;
