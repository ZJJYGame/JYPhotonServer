...
namespace JYGame
{
    ...
    /// 数据流对象
    /// </summary>
    public class GenericDataStream<T> : IDisposable
    {
        /// <summary>
        /// 是否正在写入数据；
        /// </summary>
        ...
        /// </summary>
        List<T> writeData;
        public List<T> WriteData { get { return writeData; } }
        /// <summary>
        /// 读取的数据；
        /// </summary>
        T[] readData;
        ...
        /// </summary>
        int pos;
        public GenericDataStream(bool write, T[] incomingData)
        {
            this.CanWrite = write;
        ...
        public void SetReadStream(T[] incomingData, int pos = 0)
        {
            this.readData = incomingData;
            this.pos = pos;
            this.CanWrite = false;
        ...
        /// <param name="pos">序列号</param>
        internal void SetWriteStream(List<T> newWriteData, int pos = 0)
        {
        ...
        public void Reset()
        {
            if (CanWrite) writeData.Clear(); else readData = null;
        }
    }
}
