...
namespace AscensionServer
{
    ...
    public class JYClientPeer : Photon.SocketServer.ClientPeer
    {
        ...
        protected override void OnDisconnect(DisconnectReason reasonCode, string reasonDetail)
        {
            ...
            foreach (JYClientPeer temPeer in AscensionServer.ServerInstance.peerList)
            {
                if (!string.IsNullOrEmpty(temPeer.account)&&temPeer.account!=account)
                {
                    ...
                    data2.Add((byte)ParameterCode.UserCode.Username,account);
                    ed.Parameters = data2;
        ...
        protected override void OnOperationRequest(OperationRequest operationRequest, SendParameters sendParameters)
        {
            ...
            BaseHandler handler = Utility.GetValue(AscensionServer.ServerInstance.HandlerDict, (OperationCode)operationRequest.OperationCode);
