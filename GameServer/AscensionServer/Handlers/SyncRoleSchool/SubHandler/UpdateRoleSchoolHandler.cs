...
namespace AscensionServer
{
    public class UpdateRoleSchoolHandler : SyncRoleSchoolSubHandler
    {
        ...
        public override void Handler(OperationRequest operationRequest, SendParameters sendParameters, AscensionPeer peer)
        {
            ...
            NHCriteria nHCriteriaRoleschool = Singleton<ReferencePoolManager>.Instance.Spawn<NHCriteria>().SetValue("RoleID", roleschoolObj.RoleID);
            var roleschooltmep = Singleton<NHManager>.Instance.CriteriaSelect<RoleSchool>(nHCriteriaRoleschool);
