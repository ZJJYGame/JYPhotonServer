    ...
    public class GetMiShuSubHandle : SyncMiShuSubHandler
    {
        ...
        public override void Handler(OperationRequest operationRequest, SendParameters sendParameters, AscensionPeer peer)
        {
                ...
                Utility.Assert.NotNull(rolemishuJson, () =>
                 {
                     ...
                     roleIDlist = Utility.ToObject<List<string>>(rolemishuJson);
                 ...
                 {
                     SubDict.Add((byte)ObjectParameterCode.MiShu, Utility.ToJson(miShuIdList));
            ...
            }, () => SetResponseData(()=>
            {
                ...
                SubDict.Add((byte)ObjectParameterCode.MiShu, Utility.ToJson(new List<string>()));
