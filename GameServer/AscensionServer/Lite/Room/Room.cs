namespace AscensionServer.Lite
{
    ...
    public class Room : IDisposable
    {
        ...
        ///   and sequentially to prevent object synchronization (multi threading).
        /// </remarks>
        public void EnqueueOperation(AscensionPeer peer, OperationRequest operationRequest, SendParameters sendParameters)
        {
        ...
        ///   The send Parameters.
        /// </param>
        protected virtual void ExecuteOperation(AscensionPeer peer, OperationRequest operation, SendParameters sendParameters)
        {
        }
